...
class HtmlCollector(HtmlCollectorInterface):
    ...
    def __extraction_stock_identification(self, soup: bs) -> str:
        ...
        price = self.__extraction_pricesilvio(soup)
        print("teste dateeeeeeeeeeeeeeeeeee" + str(price))
    ...
    def __extraction_pricesilvio(self, soup: bs) -> Dict:
    ...
    def __extraction_financial_summary(self, soup: bs) -> Dict:
        ...
        print(" market_valuation_title teste" + market_valuation_title)
        print(" market_valuation_tooltip" + market_valuation_tooltip)
        print(" market_valuation_value" + market_valuation_value)
